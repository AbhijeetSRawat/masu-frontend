...
export const departmentEndpoints = {
  ...
  UPDATE_HR_MANAGER_DETAILS:
    BASE_URL + "/api/department/updateHRManagerDetails",
...
export const regularizationEndpoints = {
  ...
  getPendingRegularizationsForManager:
    BASE_URL + "/api/regularization/manager/",
...
export const attendanceEndpoints = {
  ...
  getAttendance: `${BASE_URL}/api/attendance/record/:id`,
  bulkCreateAttendance: `${BASE_URL}/api/attendance/bulk/create`,
  getEmployeeAttendanceSummary: `${BASE_URL}/api/attendance/summary/employee`,
  getDepartmentAttendanceSummary: `${BASE_URL}/api/attendance/summary/department`,
  getEmployeesUnderHRorManager: `${BASE_URL}/api/attendance/hr-manager/employees/:userId`,
  getAttendanceByDate: `${BASE_URL}/api/attendance/date/filter/:userId`,
  updateAttendance: `${BASE_URL}/api/attendance/:id`, // Fixed - was /attendance/attendance/:id
  bulkUpdateAttendance: `${BASE_URL}/api/attendance/bulk/update`,
  deleteAttendance: `${BASE_URL}/api/attendance/:id`, // Fixed typo - was /attedance
};



export const perkEndpoints = {
  createPerk: BASE_URL + "/api/perks/",
  bulkCreatePerks: BASE_URL + "/api/perks/bulk",
  getCompanyPerks: BASE_URL + "/api/perks/company/:companyId",
  updatePerkStatus: BASE_URL + "/api/perks/:perkId/status",

  // Department-based perks
  getPerksByDepartment: BASE_URL + "/api/perks/department/:departmentId",

  // Employee perk assignment
  assignPerkToEmployee: BASE_URL + "/api/perks/assign",
  bulkAssignPerks: BASE_URL + "/api/perks/assign/bulk",
  getEmployeePerks: BASE_URL + "/api/perks/employee/:employeeId",
  removeEmployeePerk: BASE_URL + "/api/perks/remove/:employeePerkId",
};
...
export const ctcEndpoints = {
  getCTCTemplate: BASE_URL + "/api/ctc/template/:companyId",
  createOrUpdateCTCTemplate: BASE_URL + "/api/ctc/template",
  createCTCAnnexure: BASE_URL + "/api/ctc/employee",
  bulkCreateCTC: BASE_URL + "/api/ctc/bulk/:companyId",
  getCTCByEmployee: BASE_URL + "/api/ctc/employee/:employeeId/:companyId",
  getAllCTCAnnexures: BASE_URL + "/api/ctc/:companyId",
  getCTCBreakdown : BASE_URL + "/api/ctc/:id/breakdown/:companyId",
  updateCTCAnnexure : BASE_URL + "/api/ctc/:ctcAnnexureId/:companyId",
  getFlexiEligibleEmployees : BASE_URL +"/api/ctc/flexi/eligible/:companyId",
  calculateHRAExemptionAPI : BASE_URL + '/api/ctc/hra/calculate/:employeeId',
};

export const flexiEndpoints = {
  getFlexiBasket: BASE_URL + "/api/flexi/basket/:companyId",
  createOrUpdateFlexiBasket: BASE_URL + "/api/flexi/basket/:companyId",
  getFlexiDeclaration: BASE_URL + "/api/flexi/declaration",
  getFlexiDeclarationForCompany :BASE_URL + "/api/flexi/declarationForCompany",
  
    
  createOrUpdateFlexiDeclaration: BASE_URL + "/api/flexi/declaration",
  submitFlexiDeclaration: BASE_URL + "/api/flexi/declaration/:id/submit",
  approveFlexiDeclaration: BASE_URL + "/api/flexi/declaration/:id/approve",
  calculateFlexiBalance: BASE_URL + "/api/flexi/calculate",
};


export const taxCalculationEndpoints = {


// Tax calculation routes
 calculateEmployeeTax : BASE_URL + '/api/tax/calculate/:employeeId/:companyId', 
getTaxComputation : BASE_URL + '/api/tax/computation/:employeeId/:companyId', 

// Tax declaration routes
submitTaxDeclaration : BASE_URL + '/api/tax/declaration',
}